...
function ServicesPageScreenOne({ heading, paragraph }) {
  ...
  return (
    <div style={gradientStyle} className={`pgscontainer ${isLoaded ? 'loaded' : ''}`}>
      <div className="content">
        ...
        >
          <button className="homePagebutton" style={{textDecoration:'none'}}>Our Projects</button>
          <button className="homePagebutton" style={{textDecoration:'none'}}>Contact Us</button>
        </div>
      </div>
...
export default ServicesPageScreenOne;
